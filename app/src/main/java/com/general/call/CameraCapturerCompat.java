...
public class CameraCapturerCompat implements VideoCapturer {
    ...
    public void switchCamera() {
        ...
        String newCameraId = cameraSource == Source.FRONT_CAMERA ? idMap.get(Source.BACK_CAMERA) : idMap.get(Source.FRONT_CAMERA);
        if (usingCamera1()) {
    ...
    private boolean isCameraIdSupported(String cameraId) {
        ...
        Integer colorFilterArrangement = cameraCharacteristics.get(CameraCharacteristics.SENSOR_INFO_COLOR_FILTER_ARRANGEMENT);

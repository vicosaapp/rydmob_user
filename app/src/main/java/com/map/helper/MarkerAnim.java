...
public class MarkerAnim {
    ...
    public static void animateMarker(final Marker marker, final GeoMapLoader.GeoMap geoMap, final Location toPosition, final float rotationAngle, final float duration) {
        if (marker == null || toPosition == null || geoMap == null) {
            return;
        }
    ...
    public void addToListAndStartNext(final Marker marker, final GeoMapLoader.GeoMap geoMap, final Location toPosition, final float rotationAngle, final float duration, final String iDriverId, final String locTime) {
...
//            currentValueAnimator.end();
        ...
        animateMarker(marker, geoMap, toPosition, rotationAngle, duration, iDriverId, locTime);
    }

    public void animateMarker(final Marker marker, final GeoMapLoader.GeoMap geoMap, final Location toPosition, final float rotationAngle, final float duration, final String iDriverId, final String locTime) {
        if (marker == null || toPosition == null || geoMap == null) {
            return;
        }
        final LatLng startPosition = marker.getPosition();
...
//        final String[] reached = {"No"};
    ...
    public void animEnd(final Marker marker, final GeoMapLoader.GeoMap geoMap, final Location toPosition, final float rotationAngle, final float duration, final String iDriverId, final String locTime) {
//        driverMarkerAnimFinished = true;
        ...
        if (data_temp != null) {
            ...
            animateMarker(marker, geoMap, location_temp, GeneralFunctions.parseFloatValue(marker.getRotation(), data_temp.get("RotationAngle")), newDuration, iDriverId, data_temp.get("LocTime"));
        }
    ...
    public HashMap<String, String> getLastLocationDataOfMarker(Marker marker) {
        ...
        if (marker == null || marker.getTitle() == null || marker.getTitle().equalsIgnoreCase("")) {
